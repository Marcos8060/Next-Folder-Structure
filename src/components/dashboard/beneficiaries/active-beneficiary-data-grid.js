...
import { getAllActiveBeneficiaries, getAllBeneficiaries } from "../../../slices/beneficiaries";
...
const ActiveBeneficiaryDataGrid = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      try {
        await dispatch(getAllActiveBeneficiaries(authUser, values));
        helpers.resetForm();
...
export default ActiveBeneficiaryDataGrid;
